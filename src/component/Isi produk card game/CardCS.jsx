...
const cardcs = ({selectedCard}) => {
  return (
    ...
    <div className="carditems card" >
        <div className="imgcarditems">
        <img src={selectedCard.Diamond4} className="card-img-topitems" alt={selectedCard && selectedCard.title} />
        </div>
      <div className="bodycard">
    ...
    <div className="carditems card" >
        <div className="imgcarditems">
        <img src={selectedCard.Diamond5} className="card-img-topitems" alt={selectedCard && selectedCard.title} />
        </div>
      <div className="bodycard">
        <h5 className="titlecard">{selectedCard.jumlahdiamond4}</h5>
        <p className="textcard">{selectedCard.property11}</p>
    ...
    <div className="carditems card" >
        <div className="imgcarditems">
        <img src={selectedCard.Diamond6} className="card-img-topitems" alt={selectedCard && selectedCard.title} />
        </div>
      <div className="bodycard">
        <h5 className="titlecard">{selectedCard.jumlahdiamond5}</h5>
        <p className="textcard">{selectedCard.property11}</p>
    ...
    <div className="carditems card" >
        <div className="imgcarditems">
        <img src={selectedCard.Diamond7} className="card-img-topitems" alt={selectedCard && selectedCard.title} />
        </div>
      <div className="bodycard">
        <h5 className="titlecard">{selectedCard.jumlahdiamond5}</h5>
        <p className="textcard">{selectedCard.property11}</p>
